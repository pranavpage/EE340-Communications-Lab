...
class task2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.rational_resampler_xxx_0 = filter.rational_resampler_fff(
                ...
                taps=None,
                fractional_bw=0.4)
        self.blocks_wavfile_source_1 = blocks.wavfile_source('/media/pranav/page/Laptop data/Coursework/Semester 9/EE340/Inputs/vocal.wav', True)
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/media/pranav/page/Laptop data/Coursework/Semester 9/EE340/Inputs/background.wav', True)
