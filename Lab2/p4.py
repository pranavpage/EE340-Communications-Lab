...
class p4(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.analog_sig_source_x_0_0_0_0 = analog.sig_source_f(quadrature_rate, analog.GR_COS_WAVE, 100000, 1, 0, 0)
        ...
        self.connect((self.analog_sig_source_x_0_0_0_0, 0), (self.blocks_multiply_xx_1_0, 1))
        self.connect((self.analog_sig_source_x_1, 0), (self.rational_resampler_xxx_0, 0))
        self.connect((self.analog_sig_source_x_1_0, 0), (self.rational_resampler_xxx_0_0, 0))
    ...
    def set_quadrature_rate(self, quadrature_rate):
        ...
        self.analog_sig_source_x_0_0_0_0.set_sampling_freq(self.quadrature_rate)
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.quadrature_rate, 20e3, 10, firdes.WIN_HAMMING, 6.76))
        self.low_pass_filter_0_0.set_taps(firdes.low_pass(1, self.quadrature_rate, 20e3, 10, firdes.WIN_HAMMING, 6.76))
